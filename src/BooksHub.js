...
function BooksHub() {
    ...
    let loadData = async () => {
        setLoading(true);
        let books = await axios.get(`https://64b1006b062767bc48257be1.mockapi.io/book`);
        setBooks(books.data);
        setLoading(false);
    }
    ...
    let bookDelete = async (id) => {
        try {
            ...
            if (ask) {
                await axios.delete(`https://64b1006b062767bc48257be1.mockapi.io/book/${id}`);
            }
            loadData();
        } catch (error) {
            console.log(error)
    ...
    return (<>
        <div className="container">
            <div className="d-sm-flex align-items-center mt-3 justify-content-between mb-4">
                <h1 className="h3 mb-0 text-gray-800">BooksHub</h1>
                                                ...
                                                <div className='col-lg-4 mx-auto'>
                                                    <div className="card mb-3" style={{ width: '18rem' }}>
                                                        ...
                                                        <ul className="list-group list-group-flush">
                                                            ...
                                                            <div>
                                                                <li className="list-group-item">Author <span className=' '>&nbsp;:&nbsp;</span>{book.author}</li>
                                                            </div>
                                                            <div>
