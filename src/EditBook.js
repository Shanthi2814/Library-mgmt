...
function EditBook() {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
     await axios.put(`https://64b1006b062767bc48257be1.mockapi.io/book/${params.id}`,values)
  ...
  let loadUser = async () => {
    try {
      let book = await axios.get(`https://64b1006b062767bc48257be1.mockapi.io/book/${params.id}`)
      formik.setValues(
        {
          name: book.data.name,
